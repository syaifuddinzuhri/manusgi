...
!(function ($) {
    ...
    $("#nav-berita").on("click", function () {
        $("#pengumuman").hide();
        $("#prestasi").hide();
        $("#publikasi-flters li").removeClass("filter-active");
        $(this).addClass("filter-active");
        $("#blog").show();
        aos_init();
    });

    $("#nav-pengumuman").on("click", function () {
        $("#blog").hide();
        $("#prestasi").hide();
        $("#publikasi-flters li").removeClass("filter-active");
        $(this).addClass("filter-active");
    ...
    $("#nav-prestasi").on("click", function () {
        $("#blog").hide();
        $("#pengumuman").hide();
        $("#publikasi-flters li").removeClass("filter-active");
        $(this).addClass("filter-active");
