...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content mb-4">
            <div class="container-fluid">
                <div class="row">
                    <a href="javscript:void(0)" class="btn btn-primary" data-toggle="modal" data-target="#addUserModal">
                        <i class="fa fa-plus" aria-hidden="true"></i>
                        Tambah User
                    </a>
                    <button class="btn btn-success mx-2" id="sync-user">
...
@section('modalPage')
    ...
    <div class="modal fade" id="deleteUserModal" tabindex="-1" aria-labelledby="deleteUserModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteUserModalLabel">Apakah Anda ingin menghapus data ini?</h5>
                    <button type="button" class="close btn-close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <form id="formDeleteUser" class="d-inline" method="POST">
                        {{ csrf_field() }}
                        {{ method_field('DELETE') }}
                        <button id="deleteUser" type="submit" class="btn btn-danger btn-submit">
                            Hapus
                        </button>
                    </form>
                </div>
