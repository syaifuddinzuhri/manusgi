        ...
        <section class="content">
            <div class="row">
                <div class="col-md-10">
                    <div class="card">
                        <div class="card-body">
                            <form role="form" id="formAddPengumuman" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label for="nama">Nama<sup class="text-danger">*</sup></label>
                                    <input type="text" name="nama" class="form-control" id="nama"
                                        placeholder="Masukkan nama pengumuman" autofocus value="{{ old('name') }}">
                                </div>
                                <div class="form-group">
                                    <label for="keterangan-pengumuman">Keterangan</label>
                                    <textarea class="textarea" id="keterangan-pengumuman" name="ket_pengumuman"
                                        data-url-delete="{{ route('backend.pengumuman_deleteimage') }}"
                                        data-url-upload="{{ route('backend.pengumuman_uploadimage') }}"
                                        value="{{ old('keterangan') }}"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="file">File</label>
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" name="file" id="file-pengumuman">
