...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content mb-4">
            <div class="container-fluid">
                <div class="row">
                    <a href="javscript:void(0)" class="btn btn-primary" data-toggle="modal" data-target="#addKategoriModal">
                        <i class="fa fa-plus" aria-hidden="true"></i>
                        Tambah Kategori
                    </a>
                    <button class="btn btn-success mx-2" id="sync-kategori">
...
@section('modalPage')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" id="form-add-kategori">
                        @csrf
                        <div class="form-group">
                            <label for="nama">Name</label>
                            <input type="text" name="nama" class="form-control" id="nama"
                                placeholder="Masukkan nama kategori" value="{{ old('nama') }}" autofocus>
                        </div>
                        <div class="row">
                            <div class="col-12 text-right btn_group">
                                ...
                                <button type="submit" class="btn btn-primary btn-submit btn-kategori">
    ...
    <div class="modal fade" id="editKategoriModal" tabindex="-1" aria-labelledby="editKategoriModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" id="form-edit-kategori">
                        @csrf
                        <div class="form-group">
                            <label for="nama">Name</label>
    ...
    <div class="modal fade" id="deleteKategoriModal" tabindex="-1" aria-labelledby="deleteKategoriModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteKategoriModalLabel">Apakah Anda ingin menghapus data ini?</h5>
                    <button type="button" class="close btn-close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <form id="formDeleteKategori" class="d-inline" method="POST">
                        {{ csrf_field() }}
                        {{ method_field('DELETE') }}
                        <button id="deleteKategori" type="submit" class="btn btn-danger btn-submit">
                            Hapus
                        </button>
                    </form>
                </div>
...
@section('pageJS')
    ...
    {{-- Script Page --}}
    <script src="{{ asset('js/backend') }}/kategori.js" type="module"></script>
